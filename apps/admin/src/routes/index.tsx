      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {guitars.map((guitar) => {
          ...
          return (
            <div
              key={guitar.id}
              className="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform hover:scale-105 border border-gray-200"
            >
              <img
                src={guitar.image}
                alt={guitar.name}
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mb-3">{guitar.shortDescription}</p>
