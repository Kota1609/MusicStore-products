  ...
  return (
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="flex flex-wrap items-center gap-2 text-gray-900">
        <button
          className="px-3 py-1 bg-gray-50 rounded-md hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-200"
        ...
        <span className="flex items-center gap-1">
          ...
          <input
            ...
            className="w-16 px-2 py-1 bg-white rounded-md border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
          />
        </span>
        <select
          ...
          className="px-2 py-1 bg-white rounded-md border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
        >
